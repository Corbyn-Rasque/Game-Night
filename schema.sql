...
create table
  public.matches (
    ...
    constraint matches_3 ? _bracket_id_fkey foreign key (bracket_id) references brackets (id) on delete cascade,
...
create table
  public.teams (
    ...
    constraint teams_bracket_id_fkey foreign key (bracket_id) references brackets (id) on delete cascade
  ) tablespace pg_default;